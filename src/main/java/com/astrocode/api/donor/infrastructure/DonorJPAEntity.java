...
public class DonorJPAEntity implements Serializable {
    ...
    public DonorJPAEntity() {
    }

    public DonorJPAEntity(UUID id, UUID userId, String displayName, String document,
                          PhoneBR phone, Location address, Instant createdAt, Instant updatedAt, Instant activatedAt) {
        this.id = id;
        this.userId = userId;
